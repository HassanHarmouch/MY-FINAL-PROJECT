        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-6">
              <div className="relative h-8 w-8 overflow-hidden rounded-full bg-gradient-to-br from-eco to-water-dark">
                <div className="absolute inset-0.5 rounded-full bg-white" />
                <div className="absolute inset-1.5 rounded-full bg-gradient-to-br from-eco-light to-water-light" />
              </div>
              <span className="text-xl font-semibold">EcoConnect</span>
            </Link>
            <p className="text-sm text-foreground/70 mb-6">
              Connecting people with recycling solutions for a cleaner, greener future.
            </p>
            <div className="flex space-x-4">
              {/* Social Icons */}
              <a href="#" className="w-8 h-8 rounded-full bg-foreground/5 flex items-center justify-center hover:bg-foreground/10 transition-colors">
          ...
          {/* Features */}
          <div className="col-span-1">
            <h3 className="text-sm font-semibold mb-6">Features</h3>
            <ul className="space-y-4">
              <li><Link to="/find-centers" className="text-sm text-foreground/70 hover:text-primary transition-colors">Find Centers</Link></li>
              <li><Link to="/recycle-request" className="text-sm text-foreground/70 hover:text-primary transition-colors">Recycle Request</Link></li>
              <li><Link to="/about" className="text-sm text-foreground/70 hover:text-primary transition-colors">Direct Communication</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-sm text-foreground/70 hover:text-primary transition-colors">Eco Tips</a></li>
